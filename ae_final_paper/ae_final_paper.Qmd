...
In our analysis, we utilized the R programming language to fit a logit model to the data. Specifically, we employed the logit function，polr [^1] at the beginning, which is suitable for estimating ordered choice models.
...
[^9]: Please refer to the Appendix of the paper for the relevant code pertaining to the anova which is a example of variables selection.
...
[^10]: Please refer to the Appendix of the paper for the relevant code pertaining to the margins.oglmx algorithm for marginal effects.
