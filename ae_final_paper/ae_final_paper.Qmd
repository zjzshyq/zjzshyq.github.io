...
In our analysis, we utilized the R programming language to fit a logit method to the data. Specifically, we employed the logit function，polr, see @sec-polr , which is suitable for estimating ordered choice model as our baseline.
